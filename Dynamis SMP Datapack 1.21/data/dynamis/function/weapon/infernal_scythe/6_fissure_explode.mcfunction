...
#Deal Damage
execute as @e[type=!#dynamis:nalive,distance=..3,predicate=!dynamis:infernal_scythe/either_level/hold_either] run damage @s 12.0 magic by @p[predicate=dynamis:infernal_scythe/upgraded/hold_either]